...
void treeGenerator() {
   ...
   /* ----------------------------------------------- */
   /*  1 */ generateTree("T");
   /*  2 */ generateTreeArray("TA");
   /*  3 */ generateTreeVector("TV");
   /*  4 */ generateTreeVectorClass("TVC0", 0);
   /*  5 */ generateTreeVectorClass("TVC2", 2);
   /*  6 */ generateTreeContainers("TCon");
   /*  7 */ generateTreeTObjArray("TTObj");
   /*  8 */ generateTreeTClonesArray("TCA0", 0);
   /*  9 */ generateTreeTClonesArray("TCA2", 2);
   /* 10 */ generateTreeStruct("TS");
   /* 11 */ generateTreeClass("TC0", 0);
   /* 12 */ generateTreeClass("TC2", 2);
   /* 13 */ generateTreeClassNested("TCN0", 0);
   /* 14 */ generateTreeClassNested("TCN1", 1);
   /* 15 */ generateTreeClassNested("TCN2", 2);
   /* 16 */ generateTreeClassWithArray("TCWA");
   /* 17 */ generateTreeClassWithVector("TCWV");
   /* 18 */ generateTreeClassWithClones("TCWC");
   /* 19 */ generateTreeEventTreeSimple("TET0", 0);
   /* 20 */ generateTreeEventTreeSimple("TET1", 1);
   /* 21 */ generateTreeEventTreeSimple("TET2", 2);
   /* 22 */ generateTreeNestedVector("TNV");
   /* 23 */ generateTreeNestedClones("TNC");
   /* 24 */ generateTreeNestedArray("TNA");
   /* 25 */ generateTreeDuplicateName("TDN");
}
